...
public class ImageJS {
	...
	/**
	 * @see {@link #ImageJS.fitInto(Image,int,int)}
	 */
	public static Image fitInto(Image i, Dimension size) {
		return fitInto(i, size.width, size.height);
	}

	/**
	 * @see {@link #ImageJS.fitOnto(Image,int,int)}
	 */
	public static Image fitOnto(Image i, Dimension size) {
		return fitOnto(i, size.width, size.height);
	}
